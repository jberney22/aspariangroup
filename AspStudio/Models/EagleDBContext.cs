...
namespace EagleApp.Models
{
    public partial class eagledbContext : DbContext
    {
        ...
        public virtual DbSet<ZzTempFixClosedOutDate> ZzTempFixClosedOutDates { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VGetJobLog>(entity =>
            {
                ...
                entity.Property(e => e.MissedBy).HasMaxLength(101);
            ...
            modelBuilder.Entity<ZzTempFixClosedOutDate>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("zzTempFixClosedOutDates");

                entity.Property(e => e.BidNumber).HasMaxLength(4000);

                entity.Property(e => e.CloseoutsDoneDate).HasColumnType("datetime");
            });
